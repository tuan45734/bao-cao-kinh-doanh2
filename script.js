    ...
    if (typeof switchComparisonType === 'function') {
        ...
        if (areaSelect && typeof getAreasByRegion === 'function') {
            ...
            areaSelect.innerHTML = '<option value="">Tất cả khu vực</option>' + 
                getAreasByRegion(selectedRegion).map(area => `<option value="${area}">${area}</option>`).join('');
        }
...
const nppMapping = {
    ...
    'NPP Tiên Lan (Nghỉ)': { kv: 'KV5', region: 'MB' },
    'NPP Duy Khoa': { kv: 'KV5', region: 'MB' },
    ...
    'NPP Thành Hân': { kv: 'KV6', region: 'MB' },
    'NPP Anh Viên': { kv: 'KV7', region: 'MT' },
    'NPP Dương Thiên Nhi': { kv: 'KV7', region: 'MT' },
    'NPP Hiền Thuận': { kv: 'KV7', region: 'MT' },
    'NPP Hoàng Gia Bảo': { kv: 'KV7', region: 'MT' },
    'NPP Minh Huy': { kv: 'KV7', region: 'MT' },
    'NPP NAKOA': { kv: 'KV7', region: 'MT' },
    'NPP Nam Khánh': { kv: 'KV7', region: 'MT' },
    'NPP Thanh Trà': { kv: 'KV7', region: 'MT' },
    'NPP Thúy Diễm': { kv: 'KV7', region: 'MT' },
    'NPP Trung Nam': { kv: 'KV7', region: 'MT' },
    'NPP Tâm Bảo Hân': { kv: 'KV7', region: 'MT' },
    'NPP Tường Vy': { kv: 'KV7', region: 'MT' }
};
